    ...
    <section>
        <div className='wave d-flex flex-column justify-content-center pt-5 display-4'>
          ...
          <div className=' d-flex justify-content-center h-auto' style={{backgroundColor: '#A1CDF4'}}>
            <h1 className='bodyWidth h-auto m-0 px-5 text-align-center'>
              Lindsay Mulhollen is a dev manager, front-end developer, and artist with a fascination for how humans interact with technology as users and builders.
              </h1>
          </div>
