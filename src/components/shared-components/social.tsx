...
import { 
  myspaceIcon as myspace,
  myspaceIcon_hover as myspaceHover 
} from '@/img/Myspace';
  ...
  return (
    <section className='socials'>
      <div className='d-flex justify-content-center align-items-center'>
        <a href={`mailto:hi@lindsaymulhollen.com`} className='mr-3 icon-link'><Envelope /></a>
...
const Envelope = () => {
  return (
    <svg aria-hidden='true' focusable='false' data-prefix='fas' data-icon='envelope-square' className='svg-inline--fa fa-envelope-square fa-w-14' role='img' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 448 512'>
